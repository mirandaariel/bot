...
class _mensaje_respuestaBase extends clas {
  
  // ------------------------------------------------------------------------------------------- INI
  public function _mensaje_respuestaBase () {
    $this->a_view = array(
        "a_list" => array(
    ...
    $this->aBase['aEnti'][] = "mensaje_respuesta";                                                               // nombre de la tabla en la base de datos.
