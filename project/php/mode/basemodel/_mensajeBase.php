...
class _mensajeBase extends clas {
  
  // ------------------------------------------------------------------------------------------- INI
  public function _mensajeBase () {
    $this->a_view = array(
        "a_list" => array(
    ...
    $this->a_property = array(
      ...
      "conversacion_id" => array(
        "b_key"    => false,
        "b_unique" => false,
        "s_name"   => "conversacion_id",
        "s_type"   => "int",
        "s_label"  => "conversacion_id",
        "a_grid"   => array(
            "s_field"        => "conversacion_id",
            "s_column_label" => "",
            "s_align"        => "left",
            "i_width"        => 100,
            "i_height"       => 30,
    ...
    $this->aGrid = array( 
      ...
      array( "valor", "valor", 60, 30, true, "center", false, false ), 
      array( "fecha_creacion", "fecha_creacion", 60, 30, true, "center", false, false ), 
      array( "conversacion_id", "conversacion_id", 60, 30, true, "center", false, false ), 
      array( "usuario_id", "usuario_id", 60, 30, true, "center", false, false ), 
    ...
    $this->aBase['aEnti'][] = "mensaje";                                                               // nombre de la tabla en la base de datos.
