...
/*/ logica
    ...
    switch ( $i_form_custom_step ) 
    {
        case 1:
            ...
            $a_mensaje = array(
                "title"       => "Links de videos de danza registrados!",
                "description" => "Este material es clave cuando se esté buscando bailarinas/es. Muy importante que se 
                    mantenga actualizado cada 6 meses máximo.",
            );
