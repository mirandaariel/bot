...
/*/ logica
    ...
    switch ( $i_form_custom_step ) 
    {
        case 1:
            ...
            $a_mensaje = array(
                "title"       => "Características individuales registradas!",
                "description" => "Todas las búsquedas tienen uno o más perfiles que se corresponden con los personajes
                    de la producción a realizar. Estos perfiles definen características físicas particulares, motivo por
                    el cual es tan importante este formulario. Los datos que ingreses serán utilizados en el primero de
                    los filtros del proceso de selección.",
            );
