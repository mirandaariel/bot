...
/*/ logica
    ...
    switch ( $i_form_custom_step ) 
    {
        case 1:
            ...
            $a_mensaje = array(
                "title"       => "Estudios, conocimientos e intereses registrados!",
                "description" => "Es posible que tengas experiencia y/o te apasionen otras disciplinas o temas, y lo 
                    más importante es que estos recursos pueden abrirte muchas posibilidades.",
            );
